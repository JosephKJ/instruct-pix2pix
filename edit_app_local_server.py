...
3. Try generating results with different random seeds by setting "Randomize Seed" and running generation multiple times. You can also try setting "Randomize CFG" to sampler.sampleð new Text CFG and Image CFG values each time.
...
#
# # io = gr.Interface(lambda x: "Hello, " + x + " joseph !", "textbox", "textbox")
app = gr.mount_gradio_app(app, demo, path="/gradiodemo")
